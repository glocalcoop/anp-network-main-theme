...
<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="standard-form" enctype="multipart/form-data">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'anp-network-main' ); ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'anp-network-main' ); ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="message_content"><?php _e( 'Message', 'anp-network-main' ); ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( "Send Message", 'anp-network-main' ); ?>" name="send" id="send" />
	</div>
