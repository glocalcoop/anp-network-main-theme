		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( bp_get_thread_recipients_count() <= 1 ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'anp-network-main' ); ?>

				<?php elseif ( bp_get_max_thread_recipients_to_list() <= bp_get_thread_recipients_count() ) : ?>

					<?php printf( __( 'Conversation between %s recipients.', 'anp-network-main' ), number_format_i18n( bp_get_thread_recipients_count() ) ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'anp-network-main' ), bp_get_thread_recipients_list() ); ?>

				<?php endif; ?>

			</span>

			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Conversation", "buddypress" ); ?>"><?php _e( 'Delete', 'anp-network-main' ); ?></a>
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'anp-network-main' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<label for="message_content" class="bp-screen-reader-text"><?php _e( 'Reply to Message', 'anp-network-main' ); ?></label>
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e( 'Send Reply', 'anp-network-main' ); ?>" id="send_reply_button"/>
					</div>
