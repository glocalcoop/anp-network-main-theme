	...
	<ul id="friend-list" class="item-list">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>">
				...
				<div class="action">
					<a class="button accept" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'anp-network-main' ); ?></a> &nbsp;
					<a class="button reject" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'anp-network-main' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'You have no pending friendship requests.', 'anp-network-main' ); ?></p>
	</div>
