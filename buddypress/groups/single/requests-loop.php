...
<?php if ( bp_group_has_membership_requests( bp_ajax_querystring( 'membership_requests' ) ) ) : ?>
		...
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
			...
			<li>
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_title' => __( 'Accept', 'anp-network-main' ), 'link_text' => __( 'Accept', 'anp-network-main' ) ) ); ?>

					<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_title' => __( 'Reject', 'anp-network-main' ), 'link_text' => __( 'Reject', 'anp-network-main' ) ) ); ?>
	...
	<?php else: ?>
		...
		<div id="message" class="info">
			<p><?php _e( 'There are no pending membership requests.', 'anp-network-main' ); ?></p>
		</div>
