...
<?php if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				<li>
					<a href="#post-topic-reply"><?php _e( 'Reply', 'anp-network-main' ); ?></a>
				</li>
		...
		<div id="topic-meta">
			<h3><?php _e( 'Edit:', 'anp-network-main' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)</h3>
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<p class="submit"><input type="submit" name="save_changes" id="save_changes" value="<?php esc_attr_e( 'Save Changes', 'anp-network-main' ); ?>" /></p>
		...
		<?php else : ?>
			...
			<div id="edit-post">
				...
				<label for="post_text" class="bp-screen-reader-text"><?php _e( 'Edit text', 'anp-network-main' ); ?></label>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'This topic does not exist.', 'anp-network-main' ); ?></p>
	</div>
