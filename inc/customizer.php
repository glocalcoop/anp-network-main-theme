...
function anp_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'colors', array(
		'title' => __( 'Colors', 'anp-main-theme' ),
		'description' => __( 'Description', 'anp-main-theme' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'primary_color', array(
		'label' => __( 'Primary Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Secondary Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'secondary_color', array(
		'label' => __( 'Secondary Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Accent Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'accent_color', array(
		'label' => __( 'Accent Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Page Background Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_background_color', array(
		'label' => __( 'Page Background Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Post Background Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_background_color', array(
		'label' => __( 'Post Background Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Heading Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'heading_color', array(
		'label' => __( 'Heading Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Text Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'text_color', array(
		'label' => __( 'Text Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );

	//Link Color
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label' => __( 'Link Color', 'anp-main-theme' ),
		'section' => 'colors'
	) ) );
